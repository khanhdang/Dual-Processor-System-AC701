...
xv_path="E:/Program/Xilinx/Vivado/2016.4"
...
{
  file="xsim.ini"
  lib_map_path="E:/Program/Xilinx/Vivado/2016.4/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
